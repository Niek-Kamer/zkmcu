...
Rule: if you're optimising an extension-arithmetic hot path and you want it to actually show up in wall clock, measure Hazard3 first. If it helps there but not on M33, that's expected, the M33 compiler probably had it already. See [the finding](https://github.com/Niek-Kamer/zkmcu/blob/main/.claude/findings/2026-04-24-karatsuba-isa-asymmetric.md) for the full writeup.
...
Raw runs under [`benchmarks/runs/2026-04-24-{m33,rv32}-stark-fib-1024-babybear-q{,-kara}`](https://github.com/Niek-Kamer/zkmcu/tree/main/benchmarks/runs). Full typst report at [`research/reports/2026-04-25-babybear-quartic-cross-isa.typ`](https://github.com/Niek-Kamer/zkmcu/blob/main/research/reports/2026-04-25-babybear-quartic-cross-isa.typ).
