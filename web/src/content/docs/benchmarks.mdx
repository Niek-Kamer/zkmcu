...
import { us, proofBytes } from '../../lib/benchmarks';
	...
	rows={[
		{
			...
			emphasize: true,
			cells: [
				{ us: us("2026-04-24-m33-stark-fib-1024-q-tlsf", "stark_verify_fib_1024_q_tlsf") },
				{ us: us("2026-04-24-rv32-stark-fib-1024-q-tlsf", "stark_verify_fib_1024_q_tlsf") },
			],
		...
		},
		{
			...
			cells: [
				{ us: us("2026-04-22-m33-heap-96k-confirmed", "groth16_verify_square") },
				{ us: us("2026-04-21-rv32-stack-painted", "groth16_verify") },
			],
			proofBytes: 256,
		},
		{
			...
			emphasize: true,
			cells: [
				{ us: us("2026-04-22-m33-semaphore-depth10", "groth16_verify_semaphore") },
				{ us: us("2026-04-22-rv32-semaphore-depth10", "groth16_verify_semaphore") },
			],
			proofBytes: 256,
		},
		{
			...
			sublabel: "1 public input (square)",
			cells: [
				{ us: us("2026-04-22-m33-bls12-baseline", "groth16_verify_square") },
				{ us: us("2026-04-22-rv32-bls12-baseline", "groth16_verify_square") },
			],
			proofBytes: 512,
		},
	]}
