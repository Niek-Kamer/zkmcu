...
// TLSF gives O(1) alloc/free (two-level segregated fit), deterministic
// enough to bring variance close to the bump allocator's 0.08 % IQR
// while still supporting dealloc so heap_peak stays at production-
// viable ~90 KB under the 128 KB hardware-wallet tier.
#[global_allocator]
