...
pub static PICOTOOL_ENTRIES: [hal::binary_info::EntryAddr; 4] = [
    ...
    hal::binary_info::rp_program_description!(
        c"zkmcu: PQ-Semaphore reject-time benchmark (Cortex-M33)"
    ),
...
fn main() -> ! {
    ...
    let mut bench = Bench::new(
        ...
        BenchConfig {
            manufacturer: "zkmcu",
            product: "bench-rp2350-m33-pq-semaphore-reject",
            serial: "0001",
        },
    );
    ...
    let _ = writeln!(
        &mut boot_line,
        "zkmcu boot: heap=384K sys=150MHz core=cortex-m33 alloc=tlsf proof={VEC_LABEL} mode=reject patterns={} iters={ITERATIONS}\r",
        ALL.len(),
    );
